    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('exerciseRoutine', models.ManyToManyField(related_name='routine', through='lockedinapi.ExerciseRoutine', to='lockedinapi.exercise')),
        ...
        migrations.AddField(
            ...
            name='routine',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exercise_routine', to='lockedinapi.routine'),
        ),
        migrations.AddField(
            model_name='exercise',
            name='muscleGroup',
